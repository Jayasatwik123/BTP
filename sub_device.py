...
import time
# Constants
MAIN_DEVICE_IP = '192.168.69.30'  # Replace with the main device IP
PORT = 5000
BUFFER_SIZE = 4096
...
class DebrisAgent(Agent):
    def __init__(self, unique_id, model, image_paths=None):
    ...
    def classify_debris(self, image_path):
        ...
        return {
            "70% damage": {"regions": count_70, "total_area": total_area_70},
            "80% damage": {"regions": count_80, "total_area": total_area_80},
            "90% damage": {"regions": count_90, "total_area": total_area_90},
            "100% damage": {"regions": count_100, "total_area": total_area_100}
        }
...
if __name__ == "__main__":
    ...
    if folder_path:
        ...
        with open(output_file_path, 'w') as file:
            # Write the header
            file.write(data.to_csv(index=False, header=True, sep='\t'))
